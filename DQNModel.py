...
class DQN:
    ...
    def __init__(
        ...
        self.target_network = Network3D(
                agents, n_sample_points, number_actions).to(
                self.device)
