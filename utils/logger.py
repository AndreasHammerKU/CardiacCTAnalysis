...
class MedicalLogger:
    ...
    def create_dataframes(self):
        ...
        self.val_df = pd.DataFrame(columns=["train_episode", "episode", "total_reward", "end_avg_dist", "avg_err_in_mm", "worst_err_in_mm", "avg_closest_point", "avg_furthest_point"])
    ...
    def insert_val_row(self, train_episode, episode, total_reward, end_avg_dist, avg_err_in_mm, worst_err_in_mm, avg_closest_point, avg_furthest_point):
        self.debug(f"Inserting row into val_df: episode={episode}")
        self.val_df.loc[len(self.val_df)] = [train_episode, episode, total_reward, end_avg_dist, avg_err_in_mm, worst_err_in_mm, avg_closest_point, avg_furthest_point]
